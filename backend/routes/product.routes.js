...
import { uploadImage, deleteImage, deleteMultipleImages } from '../utils/upload.js';
...
// @access  Private/Admin
router.delete('/:id/images/:publicId', protect, authorize('admin'), asyncHandler(async (req, res) => {
  const product = await Product.findById(req.params.id);
  ...
  const imageIndex = product.images.findIndex(img => img.public_id === req.params.publicId);
...
// @access  Public
router.get('/filters/all', asyncHandler(async (req, res) => {
